...
int main( ) {
  ...
  tree.insert(O);
  printOrders(&tree);
  tree.visualizeTree("expr2.dot");

  cout << "----------------------------------------------------" << endl;
  cout << "Test 3" << endl;
  tree.insert(G);
  printOrders(&tree);
  tree.visualizeTree("expr3.dot");
  cout << "----------------------------------------------------" << endl;
  cout << "Test 4" << endl;
  tree.insert(K);
  tree.visualizeTree("expr4.dot");
  tree.insert(P);
  printOrders(&tree);
  ...
  cout << "Test 5" << endl;
  tree.insert(N);
  tree.visualizeTree("expr6.dot");
  tree.insert(E);
  tree.visualizeTree("expr7.dot");
  printOrders(&tree);
  cout << "----------------------------------------------------" << endl;
  cout << "Test 6" << endl;
  tree.insert(I);
  printOrders(&tree);
  tree.visualizeTree("expr8.dot");
  cout << "----------------------------------------------------" << endl;
  cout << "Test 7" << endl;
  if (!tree.search(C) 
      || !tree.search(O) 
